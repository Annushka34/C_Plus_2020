...
//	{
//		ofstream outF("vec.txt");
//		ostream_iterator<int> ositer(outF, " ");
//		copy(v.cbegin(), v.cend(), ositer);//---(звідки(початок), звідки(кінець), куди)
//	}
//	void ReadFromFile1()
//	{	
//		vector <int> v(100);
//		ifstream inFile("vec.txt");
//		istream_iterator<int> fileIt(inFile);
//		istream_iterator<int> endF;
//		copy(fileIt, endF, back_inserter(v));//front_inserter
//		//copy(fileIt, endF, v.begin());
//
//		//---вивід в консоль
//		ostream_iterator<int>ositer(cout, ",");
//		copy(v.begin(), v.end(), ositer);
